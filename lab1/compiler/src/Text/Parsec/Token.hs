...
{-# LANGUAGE PolymorphicComponents, ScopedTypeVariables #-}
...
makeTokenParser :: forall s u m . (Stream s m Char)
...
makeTokenParser languageDef
    ...
    -- Bracketing
    -----------------------------------------------------------
    parens, braces, angles, brackets :: forall a . ParsecT s u m a -> ParsecT s u m a
    ...
    commaSep, semiSep, commaSep1, semiSep1 :: forall a . ParsecT s u m a -> ParsecT s u m [a]
